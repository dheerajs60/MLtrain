...
# REMOVED: 'hour', 'minute', 'time_minutes', 'sin_time', 'cos_time'
features = [
    'RoadType', 'NumberofLanes', 'LargeVehicles', 'Landmarks', 'Temperature', 'Weather',
    'latitude', 'longitude', 'geohash', 'geohash_prefix4', 'geohash_prefix5',
...
print(f"Time-Agnostic LGBM R2 on Day 49 ONLY: {score_lgb:.4f}")
